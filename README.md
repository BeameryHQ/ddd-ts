...
The `DomainEventsBroker` implementation is based on [Khalil Stemmler's port](https://khalilstemmler.com/articles/typescript-domain-driven-design/chain-business-logic-domain-events/) of [Udi Dahan's 2009 blog post about Domain Events in C#](http://udidahan.com/2009/06/14/domain-events-salvation/).
